...
Route::middleware('auth')->group(function () {
    Route::prefix('/api')->group(function () {
        ...
        Route::get('/api/allocation/generate-pdf', [AllocationController::class, 'generatePdf']);
        ...
        Route::middleware('ajax')->group(function () {
            ...
            Route::post('/allocation/download-pdf', [AllocationController::class, 'downloadHistoryPdf'])
        ->name('allocation.history.pdf');
            // Expense routes
